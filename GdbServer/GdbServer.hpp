...
class GdbServer {
  ...
  private:
    ...
    const std::string riscv32RegisterXML = R"(
    <?xml version="1.0"?>
    ...
    <feature name="org.gnu.gdb.riscv.csr">
        <reg name="mstatus" bitsize="32" type="int" regnum="838"/>
        <reg name="misa" bitsize="32" type="int" regnum="839"/>
        <reg name="medeleg" bitsize="32" type="int" regnum="840"/>
        <reg name="mideleg" bitsize="32" type="int" regnum="841"/>
        <reg name="mie" bitsize="32" type="int" regnum="842"/>
        <reg name="mtvec" bitsize="32" type="int" regnum="843"/>
        <reg name="mscratch" bitsize="32" type="int" regnum="902"/>
        <reg name="mepc" bitsize="32" type="int" regnum="903"/>
        <reg name="mcause" bitsize="32" type="int" regnum="904"/>
        <reg name="mtval" bitsize="32" type="int" regnum="905"/>
        <reg name="mip" bitsize="32" type="int" regnum="906"/>
        <reg name="mvendorid" bitsize="32" type="int" regnum="3927"/>
        <reg name="marchid" bitsize="32" type="int" regnum="3928"/>
    </feature>
